...
#### 🔸 Pula 15 Umiejętności "Outside the Box" (Zainspirowane kinem i grami — rygorystycznie dostosowane do sterowania całym plutonem myszką)
1. **⏱️ Filmowy Bullet-Time 360°** – Wciśnięcie `SPACJI` zatrzymuje czas całego świata na 6s w stazie; gracz może w spokoju wycelować myszką i zaznaczyć 10 wrogów, po czym zwolnienie puszcza i Snajper likwiduje ich serię błyskawicznych strzałów (*Red Dead Redemption / Cyberpunk*)!
2. **👻 Widmowa Projekcja** – Snajper wysyła przed oddział swojego widmowego klona pędzącego w stronę celownika myszy: wrogowie strzelają w klona, a każdy wróg, który go zaatakuje, otrzymuje debuff x400% do obrażeń krytycznych od luf naszego zespołu.
3. **🌌 Oko Proroka (Lot Ptaka)** – Oddalenie kamery (zoom-out) rośnie do takiego poziomu, że gracz widzi strefę 4000x4000px na raz z góry z pełną kontrolą celowania całego plutonu.
4. **🌀 Hipnoza Celownika Optycznego** – Puszcza zajączka optycznego w stożek celowania myszy: 20 wrogów zaczyna bezradnie podążać za wskaźnikiem myszy gracza wprost na miny polowe Inżyniera.
5. **💀 Siatka Mrocznego Żniwiarza** – Snajper rozkłada pasywny kamuflaż optyczny **na cały oddział stojący obok niego**. Każde zabójstwo z ukrycia odnawia niewidzialność całego zespołu o kolejne 3s.
6. **🛸 Tryb Predator (Termiczny Tri-Laser)** – *(Predator)*: Snajper włącza trzy czerwone kropki celownika. Gdy gracz trzyma kursor myszy na wrogu przez 2s, działko naramienne Snajpera automatycznie spopiela cel z odległości 800px bez przerywania ruchu plutonu.
7. **📦 Mega-Pudło Taktyczne (MGS)** – *(Metal Gear Solid)*: Wciśnięcie `C` zrzuca **wielki karton kamuflujący na cały oddział**. Pluton porusza się razem pod jednym pudłem z wykrzyknikiem `!`. Wrogowie je ignorują, a pierwszy strzał z wnętrza pudła zadaje obrażenia x1000%.
8. **⏪ Inwersja Balistyczna** – *(Tenet)*: Strzał odwróconym pociskiem. Nabój pojawia się wewnątrz ciała martwego wroga na krawędzi ekranu i **wylatuje z niego z powrotem do lufy Snajpera**, raniąc wrogów i ożywiając zabitych rekrutów stojących na torze lotu!
9. **↪️ Zakrzywianie Kul** – *(Wanted)*: Wciskając PPM i machając myszą po łuku nadajesz pociskowi trajektorię bumeranga okrążającego formację plutonu i ścinającego głowy hordzie.
10. **🕶️ Pole Termo-Optyczne** – *(Ghost in the Shell)*: Snajper aktywuje generator rozszczepiający światło **dla całego składu**. Wrogie pociski przelatują przez żołnierzy na wylot (100% dodge), raniąc wrogów z tyłu.
11. **🦅 Linowa Pułapka Asasyna** – *(Assassin's Creed)*: Zamiast fizycznie skakać w hordę (co rozerwałoby skład), Snajper wystrzeliwuje harpuny linowe z dżungli, które przyciągają 5 elitarnych wrogów wprost w pułapki przed naszym oddziałem.
12. **⚡ Skok Mrugnięcia Plutonu (Blink)** – *(Dishonored)*: Snajper rzuca granat fazowy natychmiast **teleportujący całą zwartą formację zespołu** w miejsce celownika myszy (do 400px), zostawiając w starym miejscu chmurę czarnego dymu paraliżującego zombie.
13. **🟢 Gogle Sonarowo-Echolokacyjne** – *(Splinter Cell)*: Ekran przełącza się w czerń, a każdy ruch wroga generuje białe fale sonaru. Wyszukanie wroga echem daje całemu zespołowi gwarantowane przebicie przez ściany x500%.
14. **✏️ Ołówek Baba Yagi** – *(John Wick)*: Gdy w karabinie Snajpera skończy się amunicja, jego szał wręcz rośnie o 400%, likwidując wrogów podchodzących pod sam zespól i odnawiając amunicję plutonu.
15. **⚡ Symulacja Sandevistana** – *(Cyberpunk 2077)*: Dopalacz nerwowy podłączony do radia nadaje **całemu oddziałowi** prędkość ruchu +500% i neonowe powidoki na 2 sekundy. Pozwala całemu plutonowi uciec z centrum atomowego wybuchu bazy wroga!
